...
const MetaTags: React.FC<Props> = ({
  ...
  const DEFAULT_DESCRIPTION =
    "Codexa is a clone of free developer blogging platform that allows you to publish articles on your own domain and helps you stay connected with a global developer community.";
