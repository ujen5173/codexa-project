...
>(({ acticleDetails, setShareOpen }, ref) => {
  const OPTIONS = [
    ...
    },
    {
      ...
      action: () => {
        window.open(
          `https://twitter.com/intent/tweet?url=${window.location.href}&text=${acticleDetails.title}&via=${acticleDetails.by} on @codexaClone`,
          "_blank",
        );
        setShareOpen(false);
      },
    ...
    },
    {
      ...
      action: () => {
        window.open(
          `https://www.linkedin.com/shareArticle?mini=true&url=${window.location.href}&title=${acticleDetails.title}&source=codexa-clone`,
          "_blank",
        );
        setShareOpen(false);
      },
